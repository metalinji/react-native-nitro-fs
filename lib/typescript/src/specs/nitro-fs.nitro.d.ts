...
import type { NitroDownloadOptions, NitroFile, NitroFileEncoding, NitroFileStat, NitroUploadOptions } from '../type';
export interface NitroFS extends HybridObject<{
    ios: 'swift';
    android: 'kotlin';
}> {
    /**
    ...
    */
    downloadFileWithOptions(options: NitroDownloadOptions, onProgress?: (downloadedBytes: number, totalBytes: number) => void): Promise<NitroFile>;
}
//# sourceMappingURL=nitro-fs.nitro.d.ts.map