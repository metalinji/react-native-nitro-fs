...
namespace margelo::nitro::nitrofs {
  ...
  class HybridNitroFSSpec: public virtual HybridObject {
    ...
    public:
      ...
      virtual std::shared_ptr<Promise<NitroFile>> downloadFileWithOptions(const NitroDownloadOptions& options, const std::optional<std::function<void(double /* downloadedBytes */, double /* totalBytes */)>>& onProgress) = 0;
