...
namespace margelo::nitro::nitrofs {
  ...
  public:
    ...
    explicit NitroDownloadOptions(std::string serverUrl, std::string destinationPath, std::optional<std::unordered_map<std::string, std::string>> headers): serverUrl(serverUrl), destinationPath(destinationPath), headers(headers) {}
