...
namespace margelo::nitro::nitrofs::bridge::swift {
   ...
   */
  using std__vector_NitroFile_ = std::vector<NitroFile>;
  inline std::vector<NitroFile> create_std__vector_NitroFile_(size_t size) noexcept {
    std::vector<NitroFile> vector;
    vector.reserve(size);
    return vector;
  }
   ...
   */
  using std__shared_ptr_Promise_std__vector_NitroFile___ = std::shared_ptr<Promise<std::vector<NitroFile>>>;
  inline std::shared_ptr<Promise<std::vector<NitroFile>>> create_std__shared_ptr_Promise_std__vector_NitroFile___() noexcept {
    return Promise<std::vector<NitroFile>>::create();
  }
   ...
   */
  using Func_void_std__vector_NitroFile_ = std::function<void(const std::vector<NitroFile>& /* result */)>;
  /**
   * Wrapper class for a `std::function<void(const std::vector<NitroFile>& / * result * /)>`, this can be used from Swift.
   */
  class Func_void_std__vector_NitroFile__Wrapper final {
  public:
    explicit Func_void_std__vector_NitroFile__Wrapper(std::function<void(const std::vector<NitroFile>& /* result */)>&& func): _function(std::make_unique<std::function<void(const std::vector<NitroFile>& /* result */)>>(std::move(func))) {}
    inline void call(std::vector<NitroFile> result) const noexcept {
      _function->operator()(result);
    }
  private:
    std::unique_ptr<std::function<void(const std::vector<NitroFile>& /* result */)>> _function;
  } SWIFT_NONCOPYABLE;
  ...
  inline Result_std__shared_ptr_Promise_std__vector_NitroFile____ create_Result_std__shared_ptr_Promise_std__vector_NitroFile____(const std::shared_ptr<Promise<std::vector<NitroFile>>>& value) noexcept {
    return Result<std::shared_ptr<Promise<std::vector<NitroFile>>>>::withValue(value);
  }
