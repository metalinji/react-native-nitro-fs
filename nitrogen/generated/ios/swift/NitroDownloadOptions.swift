...
public extension NitroDownloadOptions {
   ...
   */
  init(serverUrl: String, destinationPath: String, headers: Dictionary<String, String>?) {
    self.init(std.string(serverUrl), std.string(destinationPath), { () -> bridge.std__optional_std__unordered_map_std__string__std__string__ in
